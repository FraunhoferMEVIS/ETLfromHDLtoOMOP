...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler(logname, "a"), logging.StreamHandler()],
)
...
cursor.execute(
    """SELECT is_inserted FROM {target_schema}.inserted_tables  WHERE
                tables= '{table}' and target_format='{target_schema}' and orginal_fromat='{source_schema}';
                            """.format(
        source_schema=source_schema, target_schema=target_schema, table=table
    )
)
...
ADD COLUMN vsid_temp BIGINT;""".format(
...
if not is_inserted:
    ...
    files = [
        "vers_to_location.sql",
        "vers_versq_to_person.sql",
        "vers_to_death.sql",
        "versq_to_observation_period.sql",
        "khfall_to_visit_occurrence.sql",
        "ambfall_to_visit_occurrence.sql",
        "zahnfall_to_visit_occurrence.sql",
        "ambfall_to_payer_plan_period.sql",
        "ambfall_to_care_site.sql",
        "versqdmp_to_procedure_occurrence.sql",
        "rez_to_provider.sql",
        "rez_to_drug_exposure.sql",
        "rez_to_cost.sql",
        "khfall_to_procedure_occurrence.sql",
        "rez_to_care_site.sql",
        "khfall_to_care_site.sql",
        "khdia_to_condition_occurrence.sql",
        "khentg_to_cost.sql",
        "khfall_to_observation.sql",
        "khfall_to_provider.sql",
        "khproz_to_procedure_occurrence.sql",
        "ambdiag_to_condition_occurrence.sql",
        "ambdiag_to_observation.sql",
        "ambfall_to_cost.sql",
        "ambfall_to_observation.sql",
        "ambfall_to_procedure_occurrence.sql",
        "ambleist_to_cost.sql",
        "ambleist_to_procedure_occurrence.sql",
        "ambleist_to_provider.sql",
        "ambops_to_procedure_occurrence.sql",
        "zahnbef_to_observation.sql",
        "zahnfall_to_cost.sql",
        "zahnfall_to_procedure_occurrence.sql",
        "zahnfall_to_provider.sql",
        "zahnleist_to_procedure_occurrence.sql",
        "rez_to_location.sql",
        "khfall_to_location.sql",
        "ambfall_to_location .sql",
    ]
    ...
    for column_name, value in columns.items():
        ...
        execute_query(
            query.format(
                target_schema=target_schema, column_name=column_name, value=value
            ),
            dbname,
            user,
            host,
    ...
    logger.info("Meta information inserted into <sourceschema>.inserted_tables")
...
total_script_time = end_script_time - start_script_time
logger.info(
    f"Total execution time constraints and indices: {total_script_time:.4f} seconds"
)
