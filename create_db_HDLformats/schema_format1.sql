...
CREATE TABLE {source_schema}.v{year}sa151 (
        ...
        "sa151_psid2"               NUMERIC(9,0) NOT NULL, 
        "sa151_psid"                CHAR(19),
...
CREATE TABLE {source_schema}.v{year}sa152 (
        ...
        "sa152_psid2"                   NUMERIC(9,0) NOT NULL,
        "sa152_psid"                    CHAR(19),
...
CREATE TABLE {source_schema}.v{year}sa153 (
        ...
        "sa153_psid2"               NUMERIC(9,0) NOT NULL,
        "sa153_psid"                CHAR(19),
...
CREATE TABLE {source_schema}.v{year}sa451 (
        ...
        "sa451_psid2"                 NUMERIC(9,0) NOT NULL,
        "sa451_psid"                  CHAR(19),
...
CREATE TABLE {source_schema}.v{year}sa551 (
        ...
        "sa551_psid2"             NUMERIC(9,0) NOT NULL,
        "sa551_psid"              CHAR(19),
...
CREATE TABLE {source_schema}.v{year}sa651 (
        ...
        "sa651_psid2"             NUMERIC(9,0) NOT NULL,
        "sa651_psid"              CHAR(19),
...
CREATE TABLE {source_schema}.v{year}sa751 (
        ...
        "sa751_psid2"             NUMERIC(9,0) NOT NULL,
        "sa751_psid"              CHAR(19),
...
CREATE TABLE {source_schema}.v{year}sa951 (
        ...
        "sa951_psid2"           NUMERIC(9,0) NOT NULL,
        "sa951_psid"            CHAR(19),
